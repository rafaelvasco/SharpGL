...
namespace SharpGL
{
    ...
    partial class GL
    {
        internal static partial class Delegates
        {
            ...
            internal delegate void BeginConditionalRender(UInt32 id, SharpGL.ConditionalRenderType mode);
            ...
            internal delegate void BeginQuery(SharpGL.QueryTarget target, UInt32 id);
            internal static BeginQuery glBeginQuery;
            internal delegate void EndQuery(SharpGL.QueryTarget target);
            internal static EndQuery glEndQuery;
            internal delegate void BeginQueryIndexed(SharpGL.QueryTarget target, UInt32 index, UInt32 id);
            internal static BeginQueryIndexed glBeginQueryIndexed;
            internal delegate void EndQueryIndexed(SharpGL.QueryTarget target, UInt32 index);
            internal static EndQueryIndexed glEndQueryIndexed;
            internal delegate void BeginTransformFeedback(SharpGL.BeginFeedbackMode primitiveMode);
            ...
            internal delegate void BindBuffer(SharpGL.BufferTarget target, UInt32 buffer);
            internal static BindBuffer glBindBuffer;
            internal delegate void BindBufferBase(SharpGL.BufferTarget target, UInt32 index, UInt32 buffer);
            ...
            internal delegate void BindFramebuffer(SharpGL.FramebufferTarget target, UInt32 framebuffer);
            ...
            internal delegate void BindRenderbuffer(SharpGL.RenderbufferTarget target, UInt32 renderbuffer);
            ...
            internal delegate void BindTexture(SharpGL.TextureTarget target, UInt32 texture);
            ...
            internal delegate void BindTransformFeedback(SharpGL.NvTransformFeedback2 target, UInt32 id);
            ...
            internal delegate void BlendEquation(SharpGL.BlendEquationMode mode);
            ...
            internal delegate void BlendEquationSeparate(SharpGL.BlendEquationMode modeRGB, SharpGL.BlendEquationMode modeAlpha);
            ...
            internal delegate void BlendFunc(SharpGL.BlendingFactorSrc sfactor, SharpGL.BlendingFactorDest dfactor);
            ...
            internal delegate void BlendFuncSeparate(SharpGL.BlendingFactorSrc srcRGB, SharpGL.BlendingFactorDest dstRGB, SharpGL.BlendingFactorSrc srcAlpha, SharpGL.BlendingFactorDest dstAlpha);
            ...
            internal delegate void BlitFramebuffer(Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, SharpGL.ClearBufferMask mask, SharpGL.BlitFramebufferFilter filter);
            internal static BlitFramebuffer glBlitFramebuffer;
            internal delegate void BlitNamedFramebuffer(UInt32 readFramebuffer, UInt32 drawFramebuffer, Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, SharpGL.ClearBufferMask mask, SharpGL.BlitFramebufferFilter filter);
            internal static BlitNamedFramebuffer glBlitNamedFramebuffer;
            internal delegate void BufferData(SharpGL.BufferTarget target, IntPtr size, IntPtr data, SharpGL.BufferUsageHint usage);
            internal static BufferData glBufferData;
            internal delegate void NamedBufferData(UInt32 buffer, Int32 size, IntPtr data, SharpGL.BufferUsageHint usage);
            ...
            internal delegate void BufferSubData(SharpGL.BufferTarget target, IntPtr offset, IntPtr size, IntPtr data);
            ...
            internal delegate FramebufferErrorCode CheckFramebufferStatus(SharpGL.FramebufferTarget target);
            internal static CheckFramebufferStatus glCheckFramebufferStatus;
            internal delegate FramebufferErrorCode CheckNamedFramebufferStatus(UInt32 framebuffer, SharpGL.FramebufferTarget target);
            internal static CheckNamedFramebufferStatus glCheckNamedFramebufferStatus;
            internal delegate void ClampColor(SharpGL.ClampColorTarget target, SharpGL.ClampColorMode clamp);
            internal static ClampColor glClampColor;
            internal delegate void Clear(SharpGL.ClearBufferMask mask);
            ...
            internal delegate void ClearBufferfi(SharpGL.ClearBuffer buffer, Int32 drawbuffer, Single depth, Int32 stencil);
            ...
            internal delegate void CompressedTexImage1D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 border, Int32 imageSize, IntPtr data);
            internal static CompressedTexImage1D glCompressedTexImage1D;
            internal delegate void CompressedTexImage2D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, Int32 imageSize, IntPtr data);
            internal static CompressedTexImage2D glCompressedTexImage2D;
            internal delegate void CompressedTexImage3D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, Int32 imageSize, IntPtr data);
            internal static CompressedTexImage3D glCompressedTexImage3D;
            internal delegate void CompressedTexSubImage1D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, SharpGL.PixelFormat format, Int32 imageSize, IntPtr data);
            ...
            internal delegate void CompressedTexSubImage2D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, SharpGL.PixelFormat format, Int32 imageSize, IntPtr data);
            ...
            internal delegate void CompressedTexSubImage3D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, SharpGL.PixelFormat format, Int32 imageSize, IntPtr data);
            ...
            internal delegate void CopyBufferSubData(SharpGL.BufferTarget readTarget, SharpGL.BufferTarget writeTarget, IntPtr readOffset, IntPtr writeOffset, IntPtr size);
            ...
            internal delegate void CopyTexImage1D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 border);
            internal static CopyTexImage1D glCopyTexImage1D;
            internal delegate void CopyTexImage2D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 height, Int32 border);
            internal static CopyTexImage2D glCopyTexImage2D;
            internal delegate void CopyTexSubImage1D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 x, Int32 y, Int32 width);
            ...
            internal delegate void CopyTexSubImage2D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 x, Int32 y, Int32 width, Int32 height);
            ...
            internal delegate void CopyTexSubImage3D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 x, Int32 y, Int32 width, Int32 height);
            ...
            internal delegate UInt32 CreateShader(SharpGL.ShaderType shaderType);
            ...
            internal delegate void CullFace(SharpGL.CullFaceMode mode);
            ...
            internal delegate void DepthFunc(SharpGL.DepthFunction func);
            ...
            internal delegate void DrawArrays(SharpGL.BeginMode mode, Int32 first, Int32 count);
            internal static DrawArrays glDrawArrays;
            internal delegate void DrawArraysIndirect(SharpGL.BeginMode mode, IntPtr indirect);
            internal static DrawArraysIndirect glDrawArraysIndirect;
            internal delegate void DrawArraysInstanced(SharpGL.BeginMode mode, Int32 first, Int32 count, Int32 primcount);
            ...
            internal delegate void DrawBuffers(Int32 n, SharpGL.DrawBuffersEnum[] bufs);
            ...
            internal delegate void DrawElements(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices);
            internal static DrawElements glDrawElements;
            internal delegate void DrawElementsBaseVertex(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 basevertex);
            internal static DrawElementsBaseVertex glDrawElementsBaseVertex;
            internal delegate void DrawElementsIndirect(SharpGL.BeginMode mode, SharpGL.DrawElementsType type, IntPtr indirect);
            internal static DrawElementsIndirect glDrawElementsIndirect;
            internal delegate void DrawElementsInstanced(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 primcount);
            ...
            internal delegate void DrawElementsInstancedBaseVertex(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex);
            ...
            internal delegate void DrawRangeElements(SharpGL.BeginMode mode, UInt32 start, UInt32 end, Int32 count, SharpGL.DrawElementsType type, IntPtr indices);
            internal static DrawRangeElements glDrawRangeElements;
            internal delegate void DrawRangeElementsBaseVertex(SharpGL.BeginMode mode, UInt32 start, UInt32 end, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 basevertex);
            internal static DrawRangeElementsBaseVertex glDrawRangeElementsBaseVertex;
            internal delegate void DrawTransformFeedback(SharpGL.NvTransformFeedback2 mode, UInt32 id);
            ...
            internal delegate void DrawTransformFeedbackStream(SharpGL.NvTransformFeedback2 mode, UInt32 id, UInt32 stream);
            ...
            internal delegate void Enable(SharpGL.EnableCap cap);
            internal static Enable glEnable;
            internal delegate void Disable(SharpGL.EnableCap cap);
            ...
            internal delegate IntPtr FenceSync(SharpGL.ArbSync condition, UInt32 flags);
            internal static FenceSync glFenceSync;
            internal delegate void Finish();
            internal static Finish glFinish;
            internal delegate void Flush();
            internal static Flush glFlush;
            internal delegate void FlushMappedBufferRange(SharpGL.BufferTarget target, IntPtr offset, IntPtr length);
            ...
            internal delegate void FramebufferRenderbuffer(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, SharpGL.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
            internal static FramebufferRenderbuffer glFramebufferRenderbuffer;
            internal delegate void NamedFramebufferRenderbuffer(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, SharpGL.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
            internal static NamedFramebufferRenderbuffer glNamedFramebufferRenderbuffer;
            internal delegate void FramebufferTexture(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level);
            ...
            internal delegate void NamedFramebufferTexture(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level);
            internal static NamedFramebufferTexture glNamedFramebufferTexture;
            internal delegate void FramebufferTextureLayer(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
            internal static FramebufferTextureLayer glFramebufferTextureLayer;
            internal delegate void NamedFramebufferTextureLayer(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
            internal static NamedFramebufferTextureLayer glNamedFramebufferTextureLayer;
            internal delegate void FrontFace(SharpGL.FrontFaceDirection mode);
            ...
            internal delegate void GenerateMipmap(SharpGL.GenerateMipmapTarget target);
            ...
            internal delegate void GetBooleanv(SharpGL.GetPName pname, [OutAttribute] Boolean[] data);
            internal static GetBooleanv glGetBooleanv;
            internal delegate void GetDoublev(SharpGL.GetPName pname, [OutAttribute] Double[] data);
            internal static GetDoublev glGetDoublev;
            internal delegate void GetFloatv(SharpGL.GetPName pname, [OutAttribute] Single[] data);
            internal static GetFloatv glGetFloatv;
            internal delegate void GetIntegerv(SharpGL.GetPName pname, [OutAttribute] Int32[] data);
            internal static GetIntegerv glGetIntegerv;
            internal delegate void GetInteger64v(SharpGL.ArbSync pname, [OutAttribute] Int64[] data);
            ...
            internal delegate void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] SharpGL.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name);
            ...
            internal delegate void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] SharpGL.ActiveUniformType[] type, [OutAttribute] System.Text.StringBuilder name);
            internal static GetActiveUniform glGetActiveUniform;
            internal delegate void GetActiveUniformBlockiv(UInt32 program, UInt32 uniformBlockIndex, SharpGL.ActiveUniformBlockParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetBufferParameteriv(SharpGL.BufferTarget target, SharpGL.BufferParameterName value, [OutAttribute] Int32[] data);
            ...
            internal delegate void GetBufferPointerv(SharpGL.BufferTarget target, SharpGL.BufferPointer pname, [OutAttribute] IntPtr @params);
            internal static GetBufferPointerv glGetBufferPointerv;
            internal delegate void GetNamedBufferPointerv(UInt32 buffer, SharpGL.BufferPointer pname, [OutAttribute] IntPtr @params);
            internal static GetNamedBufferPointerv glGetNamedBufferPointerv;
            internal delegate void GetBufferSubData(SharpGL.BufferTarget target, IntPtr offset, IntPtr size, [OutAttribute] IntPtr data);
            ...
            internal delegate void GetCompressedTexImage(SharpGL.TextureTarget target, Int32 level, [OutAttribute] IntPtr pixels);
            ...
            internal delegate void GetFramebufferAttachmentParameteriv(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, SharpGL.FramebufferParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetFramebufferAttachmentParameteriv glGetFramebufferAttachmentParameteriv;
            internal delegate void GetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, SharpGL.FramebufferParameterName pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetMultisamplefv(SharpGL.GetMultisamplePName pname, UInt32 index, [OutAttribute] Single[] val);
            internal static GetMultisamplefv glGetMultisamplefv;
            internal delegate void GetObjectLabel(SharpGL.ObjectLabel identifier, UInt32 name, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder label);
            ...
            internal delegate void GetProgramiv(UInt32 program, SharpGL.ProgramParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetQueryiv(SharpGL.QueryTarget target, SharpGL.GetQueryParam pname, [OutAttribute] Int32[] @params);
            internal static GetQueryiv glGetQueryiv;
            internal delegate void GetQueryObjectiv(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] Int32[] @params);
            internal static GetQueryObjectiv glGetQueryObjectiv;
            internal delegate void GetQueryObjectuiv(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] UInt32[] @params);
            internal static GetQueryObjectuiv glGetQueryObjectuiv;
            internal delegate void GetQueryObjecti64v(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] Int64[] @params);
            internal static GetQueryObjecti64v glGetQueryObjecti64v;
            internal delegate void GetQueryObjectui64v(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] UInt64[] @params);
            internal static GetQueryObjectui64v glGetQueryObjectui64v;
            internal delegate void GetRenderbufferParameteriv(SharpGL.RenderbufferTarget target, SharpGL.RenderbufferParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetRenderbufferParameteriv glGetRenderbufferParameteriv;
            internal delegate void GetNamedRenderbufferParameteriv(UInt32 renderbuffer, SharpGL.RenderbufferParameterName pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetShaderiv(UInt32 shader, SharpGL.ShaderParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetShaderPrecisionFormat(SharpGL.ShaderType shaderType, Int32 precisionType, [OutAttribute] Int32[] range, [OutAttribute] Int32[] precision);
            ...
            internal delegate IntPtr GetString(SharpGL.StringName name);
            internal static GetString glGetString;
            internal delegate IntPtr GetStringi(SharpGL.StringName name, UInt32 index);
            ...
            internal delegate void GetSynciv(IntPtr sync, SharpGL.ArbSync pname, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] values);
            internal static GetSynciv glGetSynciv;
            internal delegate void GetTexImage(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelFormat format, SharpGL.PixelType type, [OutAttribute] IntPtr pixels);
            ...
            internal delegate void GetTexParameterfv(SharpGL.TextureTarget target, SharpGL.GetTextureParameter pname, [OutAttribute] Single[] @params);
            internal static GetTexParameterfv glGetTexParameterfv;
            internal delegate void GetTexParameteriv(SharpGL.TextureTarget target, SharpGL.GetTextureParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] SharpGL.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name);
            ...
            internal delegate void GetVertexAttribdv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Double[] @params);
            internal static GetVertexAttribdv glGetVertexAttribdv;
            internal delegate void GetVertexAttribfv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Single[] @params);
            internal static GetVertexAttribfv glGetVertexAttribfv;
            internal delegate void GetVertexAttribiv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Int32[] @params);
            internal static GetVertexAttribiv glGetVertexAttribiv;
            internal delegate void GetVertexAttribIiv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Int32[] @params);
            internal static GetVertexAttribIiv glGetVertexAttribIiv;
            internal delegate void GetVertexAttribIuiv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] UInt32[] @params);
            internal static GetVertexAttribIuiv glGetVertexAttribIuiv;
            internal delegate void GetVertexAttribLdv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Double[] @params);
            internal static GetVertexAttribLdv glGetVertexAttribLdv;
            internal delegate void GetVertexAttribPointerv(UInt32 index, SharpGL.VertexAttribPointerParameter pname, [OutAttribute] IntPtr pointer);
            internal static GetVertexAttribPointerv glGetVertexAttribPointerv;
            internal delegate void Hint(HintTarget target, SharpGL.HintMode mode);
            ...
            internal delegate Boolean IsEnabled(SharpGL.EnableCap cap);
            ...
            internal delegate void LogicOp(SharpGL.LogicOp opcode);
            internal static LogicOp glLogicOp;
            internal delegate IntPtr MapBuffer(SharpGL.BufferTarget target, SharpGL.BufferAccess access);
            internal static MapBuffer glMapBuffer;
            internal delegate IntPtr MapNamedBuffer(UInt32 buffer, SharpGL.BufferAccess access);
            internal static MapNamedBuffer glMapNamedBuffer;
            internal delegate IntPtr MapBufferRange(SharpGL.BufferTarget target, IntPtr offset, IntPtr length, SharpGL.BufferAccessMask access);
            ...
            internal delegate void MultiDrawArrays(SharpGL.BeginMode mode, Int32[] first, Int32[] count, Int32 drawcount);
            ...
            internal delegate void MultiDrawElements(SharpGL.BeginMode mode, Int32[] count, SharpGL.DrawElementsType type, IntPtr indices, Int32 drawcount);
            internal static MultiDrawElements glMultiDrawElements;
            internal delegate void MultiDrawElementsBaseVertex(SharpGL.BeginMode mode, Int32[] count, SharpGL.DrawElementsType type, IntPtr indices, Int32 drawcount, Int32[] basevertex);
            internal static MultiDrawElementsBaseVertex glMultiDrawElementsBaseVertex;
            internal delegate void MultiDrawElementsIndirect(SharpGL.BeginMode mode, SharpGL.DrawElementsType type, IntPtr indirect, Int32 drawcount, Int32 stride);
            internal static MultiDrawElementsIndirect glMultiDrawElementsIndirect;
            internal delegate void ObjectLabel(SharpGL.ObjectLabel identifier, UInt32 name, Int32 length, String label);
            ...
            internal delegate void PixelStoref(SharpGL.PixelStoreParameter pname, Single param);
            internal static PixelStoref glPixelStoref;
            internal delegate void PixelStorei(SharpGL.PixelStoreParameter pname, Int32 param);
            internal static PixelStorei glPixelStorei;
            internal delegate void PointParameterf(SharpGL.PointParameterName pname, Single param);
            internal static PointParameterf glPointParameterf;
            internal delegate void PointParameteri(SharpGL.PointParameterName pname, Int32 param);
            ...
            internal delegate void PolygonMode(SharpGL.MaterialFace face, SharpGL.PolygonMode mode);
            ...
            internal delegate void ProgramParameteri(UInt32 program, SharpGL.Version32 pname, Int32 value);
            ...
            internal delegate void ProvokingVertex(SharpGL.ProvokingVertexMode provokeMode);
            internal static ProvokingVertex glProvokingVertex;
            internal delegate void QueryCounter(UInt32 id, SharpGL.QueryTarget target);
            internal static QueryCounter glQueryCounter;
            internal delegate void ReadBuffer(SharpGL.ReadBufferMode mode);
            ...
            internal delegate void ReadPixels(Int32 x, Int32 y, Int32 width, Int32 height, SharpGL.PixelFormat format, SharpGL.PixelType type, Int32[] data);
            internal static ReadPixels glReadPixels;
            internal delegate void ReadnPixels(Int32 x, Int32 y, Int32 width, Int32 height, SharpGL.PixelFormat format, SharpGL.PixelType type, Int32 bufSize, Int32[] data);
            internal static ReadnPixels glReadnPixels;
            internal delegate void RenderbufferStorage(SharpGL.RenderbufferTarget target, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorage glRenderbufferStorage;
            internal delegate void NamedRenderbufferStorage(UInt32 renderbuffer, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static NamedRenderbufferStorage glNamedRenderbufferStorage;
            internal delegate void RenderbufferStorageMultisample(SharpGL.RenderbufferTarget target, Int32 samples, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorageMultisample glRenderbufferStorageMultisample;
            internal delegate void NamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            ...
            internal delegate void StencilFunc(SharpGL.StencilFunction func, Int32 @ref, UInt32 mask);
            internal static StencilFunc glStencilFunc;
            internal delegate void StencilFuncSeparate(SharpGL.StencilFace face, SharpGL.StencilFunction func, Int32 @ref, UInt32 mask);
            ...
            internal delegate void StencilMaskSeparate(SharpGL.StencilFace face, UInt32 mask);
            internal static StencilMaskSeparate glStencilMaskSeparate;
            internal delegate void StencilOp(SharpGL.StencilOp sfail, SharpGL.StencilOp dpfail, SharpGL.StencilOp dppass);
            internal static StencilOp glStencilOp;
            internal delegate void StencilOpSeparate(SharpGL.StencilFace face, SharpGL.StencilOp sfail, SharpGL.StencilOp dpfail, SharpGL.StencilOp dppass);
            internal static StencilOpSeparate glStencilOpSeparate;
            internal delegate void TexBuffer(SharpGL.TextureBufferTarget target, SharpGL.SizedInternalFormat internalFormat, UInt32 buffer);
            internal static TexBuffer glTexBuffer;
            internal delegate void TextureBuffer(UInt32 texture, SharpGL.SizedInternalFormat internalFormat, UInt32 buffer);
            ...
            internal delegate void TexImage1D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 border, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr data);
            internal static TexImage1D glTexImage1D;
            internal delegate void TexImage2D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr data);
            internal static TexImage2D glTexImage2D;
            internal delegate void TexImage2DMultisample(SharpGL.TextureTargetMultisample target, Int32 samples, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
            internal static TexImage2DMultisample glTexImage2DMultisample;
            internal delegate void TexImage3D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr data);
            internal static TexImage3D glTexImage3D;
            internal delegate void TexImage3DMultisample(SharpGL.TextureTargetMultisample target, Int32 samples, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
            internal static TexImage3DMultisample glTexImage3DMultisample;
            internal delegate void TexParameterf(SharpGL.TextureTarget target, TextureParameterName pname, Single param);
            internal static TexParameterf glTexParameterf;
            internal delegate void TexParameteri(SharpGL.TextureTarget target, TextureParameterName pname, Int32 param);
            ...
            internal delegate void TexParameterfv(SharpGL.TextureTarget target, TextureParameterName pname, Single[] @params);
            internal static TexParameterfv glTexParameterfv;
            internal delegate void TexParameteriv(SharpGL.TextureTarget target, TextureParameterName pname, Int32[] @params);
            ...
            internal delegate void TexSubImage1D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr pixels);
            ...
            internal delegate void TexSubImage2D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr pixels);
            ...
            internal delegate void TexSubImage3D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr pixels);
            ...
            internal delegate void TransformFeedbackVaryings(UInt32 program, Int32 count, String[] varyings, SharpGL.TransformFeedbackMode bufferMode);
            ...
            internal delegate Boolean UnmapBuffer(SharpGL.BufferTarget target);
            ...
            internal delegate void VertexAttribFormat(UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexAttribFormat glVertexAttribFormat;
            internal delegate void VertexAttribIFormat(UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribIFormat glVertexAttribIFormat;
            internal delegate void VertexAttribLFormat(UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribLFormat glVertexAttribLFormat;
            internal delegate void VertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexArrayAttribFormat glVertexArrayAttribFormat;
            internal delegate void VertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexArrayAttribIFormat glVertexArrayAttribIFormat;
            internal delegate void VertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexArrayAttribLFormat glVertexArrayAttribLFormat;
            internal delegate void VertexAttribPointer(UInt32 index, Int32 size, SharpGL.VertexAttribPointerType type, Boolean normalized, Int32 stride, IntPtr pointer);
