...
namespace SharpGL
{
    public partial class GL
    {
        internal static class Delegates
        {
            ...
            internal delegate void BindVertexArray(UInt32 vao);
            ...
            internal delegate void GetBooleanv(GetPName pname, [Out] Boolean[] data);
            ...
            internal delegate void GetFloatv(GetPName pname, [Out] Single[] data);
            internal static GetFloatv glGetFloatv;
            internal delegate void GetIntegerv(GetPName pname, [Out] Int32[] data);
            internal static GetIntegerv glGetIntegerv;
            internal delegate void GetInteger64v(ArbSync pname, [Out] Int64[] data);
            internal static GetInteger64v glGetInteger64v;
            internal delegate void GetBooleani_v(GetPName target, UInt32 index, [Out] Boolean[] data);
            internal static GetBooleani_v glGetBooleani_v;
            internal delegate void GetIntegeri_v(GetPName target, UInt32 index, [Out] Int32[] data);
            internal static GetIntegeri_v glGetIntegeri_v;
            internal delegate void GetFloati_v(GetPName target, UInt32 index, [Out] Single[] data);
            internal static GetFloati_v glGetFloati_v;
            internal delegate void GetDoublei_v(GetPName target, UInt32 index, [Out] Double[] data);
            internal static GetDoublei_v glGetDoublei_v;
            internal delegate void GetInteger64i_v(GetPName target, UInt32 index, [Out] Int64[] data);
            internal static GetInteger64i_v glGetInteger64i_v;
            internal delegate void GetActiveAtomicCounterBufferiv(UInt32 program, UInt32 bufferIndex, AtomicCounterParameterName pname, [Out] Int32[] @params);
            internal static GetActiveAtomicCounterBufferiv glGetActiveAtomicCounterBufferiv;
            internal delegate void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] size, [Out] ActiveAttribType[] type, [Out] StringBuilder name);
            internal static GetActiveAttrib glGetActiveAttrib;
            internal delegate void GetActiveSubroutineName(UInt32 program, ShaderType shadertype, UInt32 index, Int32 bufsize, [Out] Int32[] length, [Out] StringBuilder name);
            internal static GetActiveSubroutineName glGetActiveSubroutineName;
            internal delegate void GetActiveSubroutineUniformiv(UInt32 program, ShaderType shadertype, UInt32 index, SubroutineParameterName pname, [Out] Int32[] values);
            internal static GetActiveSubroutineUniformiv glGetActiveSubroutineUniformiv;
            internal delegate void GetActiveSubroutineUniformName(UInt32 program, ShaderType shadertype, UInt32 index, Int32 bufsize, [Out] Int32[] length, [Out] StringBuilder name);
            internal static GetActiveSubroutineUniformName glGetActiveSubroutineUniformName;
            internal delegate void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] size, [Out] ActiveUniformType[] type, [Out] StringBuilder name);
            internal static GetActiveUniform glGetActiveUniform;
            internal delegate void GetActiveUniformBlockiv(UInt32 program, UInt32 uniformBlockIndex, ActiveUniformBlockParameter pname, [Out] Int32[] @params);
            internal static GetActiveUniformBlockiv glGetActiveUniformBlockiv;
            internal delegate void GetActiveUniformBlockName(UInt32 program, UInt32 uniformBlockIndex, Int32 bufSize, [Out] Int32[] length, [Out] StringBuilder uniformBlockName);
            internal static GetActiveUniformBlockName glGetActiveUniformBlockName;
            internal delegate void GetActiveUniformName(UInt32 program, UInt32 uniformIndex, Int32 bufSize, [Out] Int32[] length, [Out] StringBuilder uniformName);
            internal static GetActiveUniformName glGetActiveUniformName;
            internal delegate void GetActiveUniformsiv(UInt32 program, Int32 uniformCount, [Out] UInt32[] uniformIndices, ActiveUniformType pname, [Out] Int32[] @params);
            internal static GetActiveUniformsiv glGetActiveUniformsiv;
            internal delegate void GetAttachedShaders(UInt32 program, Int32 maxCount, [Out] Int32[] count, [Out] UInt32[] shaders);
            ...
            internal delegate void GetBufferParameteriv(BufferTarget target, BufferParameterName value, [Out] Int32[] data);
            internal static GetBufferParameteriv glGetBufferParameteriv;
            internal delegate void GetBufferParameteri64v(BufferTarget target, BufferParameterName value, [Out] Int64[] data);
            internal static GetBufferParameteri64v glGetBufferParameteri64v;
            internal delegate void GetNamedBufferParameteriv(UInt32 buffer, BufferParameterName pname, [Out] Int32[] @params);
            internal static GetNamedBufferParameteriv glGetNamedBufferParameteriv;
            internal delegate void GetNamedBufferParameteri64v(UInt32 buffer, BufferParameterName pname, [Out] Int64[] @params);
            ...
            internal delegate void GetNamedBufferPointerv(UInt32 buffer, BufferPointer pname, [Out] IntPtr @params);
            ...
            internal delegate void GetCompressedTexImage(TextureTarget target, Int32 level, [Out] IntPtr pixels);
            internal static GetCompressedTexImage glGetCompressedTexImage;
            internal delegate void GetnCompressedTexImage(TextureTarget target, Int32 level, Int32 bufSize, [Out] IntPtr pixels);
            ...
            internal delegate void GetFramebufferAttachmentParameteriv(FramebufferTarget target, FramebufferAttachment attachment, FramebufferParameterName pname, [Out] Int32[] @params);
            internal static GetFramebufferAttachmentParameteriv glGetFramebufferAttachmentParameteriv;
            internal delegate void GetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, FramebufferAttachment attachment, FramebufferParameterName pname, [Out] Int32[] @params);
            internal static GetNamedFramebufferAttachmentParameteriv glGetNamedFramebufferAttachmentParameteriv;
            internal delegate void GetFramebufferParameteriv(FramebufferTarget target, FramebufferPName pname, [Out] Int32[] @params);
            internal static GetFramebufferParameteriv glGetFramebufferParameteriv;
            internal delegate void GetNamedFramebufferParameteriv(UInt32 framebuffer, FramebufferPName pname, [Out] Int32[] param);
            ...
            internal delegate void GetInternalformativ(TextureTarget target, PixelInternalFormat internalFormat, GetPName pname, Int32 bufSize, [Out] Int32[] @params);
            internal static GetInternalformativ glGetInternalformativ;
            internal delegate void GetInternalformati64v(TextureTarget target, PixelInternalFormat internalFormat, GetPName pname, Int32 bufSize, [Out] Int64[] @params);
            internal static GetInternalformati64v glGetInternalformati64v;
            internal delegate void GetMultisamplefv(GetMultisamplePName pname, UInt32 index, [Out] Single[] val);
            internal static GetMultisamplefv glGetMultisamplefv;
            internal delegate void GetObjectLabel(SharpGL.ObjectLabel identifier, UInt32 name, Int32 bifSize, [Out] Int32[] length, [Out] StringBuilder label);
            internal static GetObjectLabel glGetObjectLabel;
            internal delegate void GetObjectPtrLabel([Out] IntPtr ptr, Int32 bifSize, [Out] Int32[] length, [Out] StringBuilder label);
            ...
            internal delegate void GetProgramBinary(UInt32 program, Int32 bufsize, [Out] Int32[] length, [Out] Int32[] binaryFormat, [Out] IntPtr binary);
            internal static GetProgramBinary glGetProgramBinary;
            internal delegate void GetProgramInfoLog(UInt32 program, Int32 maxLength, [Out] Int32[] length, [Out] StringBuilder infoLog);
            internal static GetProgramInfoLog glGetProgramInfoLog;
            internal delegate void GetProgramInterfaceiv(UInt32 program, ProgramInterface programInterface, ProgramInterfaceParameterName pname, [Out] Int32[] @params);
            internal static GetProgramInterfaceiv glGetProgramInterfaceiv;
            internal delegate void GetProgramPipelineiv(UInt32 pipeline, Int32 pname, [Out] Int32[] @params);
            internal static GetProgramPipelineiv glGetProgramPipelineiv;
            internal delegate void GetProgramPipelineInfoLog(UInt32 pipeline, Int32 bufSize, [Out] Int32[] length, [Out] StringBuilder infoLog);
            internal static GetProgramPipelineInfoLog glGetProgramPipelineInfoLog;
            internal delegate void GetProgramResourceiv(UInt32 program, ProgramInterface programInterface, UInt32 index, Int32 propCount, [Out] ProgramResourceParameterName[] props, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] @params);
            ...
            internal delegate void GetProgramResourceName(UInt32 program, ProgramInterface programInterface, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] StringBuilder name);
            internal static GetProgramResourceName glGetProgramResourceName;
            internal delegate void GetProgramStageiv(UInt32 program, ShaderType shadertype, ProgramStageParameterName pname, [Out] Int32[] values);
            internal static GetProgramStageiv glGetProgramStageiv;
            internal delegate void GetQueryIndexediv(QueryTarget target, UInt32 index, GetQueryParam pname, [Out] Int32[] @params);
            internal static GetQueryIndexediv glGetQueryIndexediv;
            internal delegate void GetQueryiv(QueryTarget target, GetQueryParam pname, [Out] Int32[] @params);
            internal static GetQueryiv glGetQueryiv;
            internal delegate void GetQueryObjectiv(UInt32 id, GetQueryObjectParam pname, [Out] Int32[] @params);
            internal static GetQueryObjectiv glGetQueryObjectiv;
            internal delegate void GetQueryObjectuiv(UInt32 id, GetQueryObjectParam pname, [Out] UInt32[] @params);
            internal static GetQueryObjectuiv glGetQueryObjectuiv;
            internal delegate void GetQueryObjecti64v(UInt32 id, GetQueryObjectParam pname, [Out] Int64[] @params);
            internal static GetQueryObjecti64v glGetQueryObjecti64v;
            internal delegate void GetQueryObjectui64v(UInt32 id, GetQueryObjectParam pname, [Out] UInt64[] @params);
            internal static GetQueryObjectui64v glGetQueryObjectui64v;
            internal delegate void GetRenderbufferParameteriv(RenderbufferTarget target, RenderbufferParameterName pname, [Out] Int32[] @params);
            internal static GetRenderbufferParameteriv glGetRenderbufferParameteriv;
            internal delegate void GetNamedRenderbufferParameteriv(UInt32 renderbuffer, RenderbufferParameterName pname, [Out] Int32[] @params);
            internal static GetNamedRenderbufferParameteriv glGetNamedRenderbufferParameteriv;
            internal delegate void GetSamplerParameterfv(UInt32 sampler, Int32 pname, [Out] Single[] @params);
            internal static GetSamplerParameterfv glGetSamplerParameterfv;
            internal delegate void GetSamplerParameteriv(UInt32 sampler, Int32 pname, [Out] Int32[] @params);
            internal static GetSamplerParameteriv glGetSamplerParameteriv;
            internal delegate void GetSamplerParameterIiv(UInt32 sampler, TextureParameterName pname, [Out] Int32[] @params);
            internal static GetSamplerParameterIiv glGetSamplerParameterIiv;
            internal delegate void GetSamplerParameterIuiv(UInt32 sampler, TextureParameterName pname, [Out] UInt32[] @params);
            internal static GetSamplerParameterIuiv glGetSamplerParameterIuiv;
            internal delegate void GetShaderiv(UInt32 shader, ShaderParameter pname, [Out] Int32[] @params);
            internal static GetShaderiv glGetShaderiv;
            internal delegate void GetShaderInfoLog(UInt32 shader, Int32 maxLength, [Out] Int32[] length, [Out] StringBuilder infoLog);
            internal static GetShaderInfoLog glGetShaderInfoLog;
            internal delegate void GetShaderPrecisionFormat(ShaderType shaderType, Int32 precisionType, [Out] Int32[] range, [Out] Int32[] precision);
            internal static GetShaderPrecisionFormat glGetShaderPrecisionFormat;
            internal delegate void GetShaderSource(UInt32 shader, Int32 bufSize, [Out] Int32[] length, [Out] StringBuilder source);
            ...
            internal delegate void GetSynciv(IntPtr sync, ArbSync pname, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] values);
            internal static GetSynciv glGetSynciv;
            internal delegate void GetTexImage(TextureTarget target, Int32 level, PixelFormat format, PixelType type, [Out] IntPtr pixels);
            internal static GetTexImage glGetTexImage;
            internal delegate void GetnTexImage(TextureTarget target, Int32 level, PixelFormat format, PixelType type, Int32 bufSize, [Out] IntPtr pixels);
            internal static GetnTexImage glGetnTexImage;
            internal delegate void GetTextureImage(UInt32 texture, Int32 level, PixelFormat format, PixelType type, Int32 bufSize, [Out] IntPtr pixels);
            internal static GetTextureImage glGetTextureImage;
            internal delegate void GetTexLevelParameterfv(GetPName target, Int32 level, GetTextureLevelParameter pname, [Out] Single[] @params);
            internal static GetTexLevelParameterfv glGetTexLevelParameterfv;
            internal delegate void GetTexLevelParameteriv(GetPName target, Int32 level, GetTextureLevelParameter pname, [Out] Int32[] @params);
            internal static GetTexLevelParameteriv glGetTexLevelParameteriv;
            internal delegate void GetTextureLevelParameterfv(UInt32 texture, Int32 level, GetTextureLevelParameter pname, [Out] Single[] @params);
            internal static GetTextureLevelParameterfv glGetTextureLevelParameterfv;
            internal delegate void GetTextureLevelParameteriv(UInt32 texture, Int32 level, GetTextureLevelParameter pname, [Out] Int32[] @params);
            internal static GetTextureLevelParameteriv glGetTextureLevelParameteriv;
            internal delegate void GetTexParameterfv(TextureTarget target, GetTextureParameter pname, [Out] Single[] @params);
            internal static GetTexParameterfv glGetTexParameterfv;
            internal delegate void GetTexParameteriv(TextureTarget target, GetTextureParameter pname, [Out] Int32[] @params);
            internal static GetTexParameteriv glGetTexParameteriv;
            internal delegate void GetTexParameterIiv(TextureTarget target, GetTextureParameter pname, [Out] Int32[] @params);
            internal static GetTexParameterIiv glGetTexParameterIiv;
            internal delegate void GetTexParameterIuiv(TextureTarget target, GetTextureParameter pname, [Out] UInt32[] @params);
            internal static GetTexParameterIuiv glGetTexParameterIuiv;
            internal delegate void GetTextureParameterfv(UInt32 texture, GetTextureParameter pname, [Out] Single[] @params);
            internal static GetTextureParameterfv glGetTextureParameterfv;
            internal delegate void GetTextureParameteriv(UInt32 texture, GetTextureParameter pname, [Out] Int32[] @params);
            internal static GetTextureParameteriv glGetTextureParameteriv;
            internal delegate void GetTextureParameterIiv(UInt32 texture, GetTextureParameter pname, [Out] Int32[] @params);
            internal static GetTextureParameterIiv glGetTextureParameterIiv;
            internal delegate void GetTextureParameterIuiv(UInt32 texture, GetTextureParameter pname, [Out] UInt32[] @params);
            internal static GetTextureParameterIuiv glGetTextureParameterIuiv;
            internal delegate void GetTextureSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, PixelFormat format, PixelType type, Int32 bufSize, [Out] IntPtr pixels);
            internal static GetTextureSubImage glGetTextureSubImage;
            internal delegate void GetTransformFeedbackiv(UInt32 xfb, TransformFeedbackParameterName pname, [Out] Int32[] param);
            internal static GetTransformFeedbackiv glGetTransformFeedbackiv;
            internal delegate void GetTransformFeedbacki_v(UInt32 xfb, TransformFeedbackParameterName pname, UInt32 index, [Out] Int32[] param);
            internal static GetTransformFeedbacki_v glGetTransformFeedbacki_v;
            internal delegate void GetTransformFeedbacki64_v(UInt32 xfb, TransformFeedbackParameterName pname, UInt32 index, [Out] Int64[] param);
            internal static GetTransformFeedbacki64_v glGetTransformFeedbacki64_v;
            internal delegate void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, [Out] Int32[] length, [Out] Int32[] size, [Out] ActiveAttribType[] type, [Out] StringBuilder name);
            internal static GetTransformFeedbackVarying glGetTransformFeedbackVarying;
            internal delegate void GetUniformfv(UInt32 program, Int32 location, [Out] Single[] @params);
            internal static GetUniformfv glGetUniformfv;
            internal delegate void GetUniformiv(UInt32 program, Int32 location, [Out] Int32[] @params);
            internal static GetUniformiv glGetUniformiv;
            internal delegate void GetUniformuiv(UInt32 program, Int32 location, [Out] UInt32[] @params);
            internal static GetUniformuiv glGetUniformuiv;
            internal delegate void GetUniformdv(UInt32 program, Int32 location, [Out] Double[] @params);
            ...
            internal delegate void GetUniformSubroutineuiv(ShaderType shadertype, Int32 location, [Out] UInt32[] values);
            internal static GetUniformSubroutineuiv glGetUniformSubroutineuiv;
            internal delegate void GetVertexArrayIndexed64iv(UInt32 vaobj, UInt32 index, VertexAttribParameter pname, [Out] Int64[] param);
            internal static GetVertexArrayIndexed64iv glGetVertexArrayIndexed64iv;
            internal delegate void GetVertexArrayIndexediv(UInt32 vaobj, UInt32 index, VertexAttribParameter pname, [Out] Int32[] param);
            internal static GetVertexArrayIndexediv glGetVertexArrayIndexediv;
            internal delegate void GetVertexArrayiv(UInt32 vaobj, VertexAttribParameter pname, [Out] Int32[] param);
            internal static GetVertexArrayiv glGetVertexArrayiv;
            internal delegate void GetVertexAttribdv(UInt32 index, VertexAttribParameter pname, [Out] Double[] @params);
            internal static GetVertexAttribdv glGetVertexAttribdv;
            internal delegate void GetVertexAttribfv(UInt32 index, VertexAttribParameter pname, [Out] Single[] @params);
            internal static GetVertexAttribfv glGetVertexAttribfv;
            internal delegate void GetVertexAttribiv(UInt32 index, VertexAttribParameter pname, [Out] Int32[] @params);
            internal static GetVertexAttribiv glGetVertexAttribiv;
            internal delegate void GetVertexAttribIiv(UInt32 index, VertexAttribParameter pname, [Out] Int32[] @params);
            internal static GetVertexAttribIiv glGetVertexAttribIiv;
            internal delegate void GetVertexAttribIuiv(UInt32 index, VertexAttribParameter pname, [Out] UInt32[] @params);
            internal static GetVertexAttribIuiv glGetVertexAttribIuiv;
            internal delegate void GetVertexAttribLdv(UInt32 index, VertexAttribParameter pname, [Out] Double[] @params);
            internal static GetVertexAttribLdv glGetVertexAttribLdv;
            internal delegate void GetVertexAttribPointerv(UInt32 index, VertexAttribPointerParameter pname, [Out] IntPtr pointer);
            ...
            internal delegate void PolygonMode(MaterialFace face, SharpGL.PolygonMode mode);
            ...
            internal delegate void RenderbufferStorage(RenderbufferTarget target, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            ...
            internal delegate void RenderbufferStorageMultisample(RenderbufferTarget target, Int32 samples, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            ...
            internal delegate void StencilOpSeparate(StencilFace face, SharpGL.StencilOp sfail, SharpGL.StencilOp dpfail, SharpGL.StencilOp dppass);
