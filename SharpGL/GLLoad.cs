...
namespace SharpGL
{
    public partial class GL
    {
        ...
        {
            private const string LibraryOSX = "libdl.dylib";

            [DllImport(LibraryOSX, EntryPoint = "NSIsSymbolNameDefined")]
            private static extern bool NSIsSymbolNameDefined(string s);
            [DllImport(LibraryOSX, EntryPoint = "NSLookupAndBindSymbol")]
            private static extern IntPtr NSLookupAndBindSymbol(string s);
            [DllImport(LibraryOSX, EntryPoint = "NSAddressOfSymbol")]
