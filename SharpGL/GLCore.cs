...
namespace SharpGL
{
    partial class GL
    {
        internal static partial class NativeMethods
        {
            ...
            internal extern static void BeginConditionalRender(UInt32 id, SharpGL.ConditionalRenderType mode);
            ...
            internal extern static void BeginQuery(SharpGL.QueryTarget target, UInt32 id);
            [DllImport(GL.Library, EntryPoint = "glEndQuery", ExactSpelling = true)]
            internal extern static void EndQuery(SharpGL.QueryTarget target);
            [DllImport(GL.Library, EntryPoint = "glBeginQueryIndexed", ExactSpelling = true)]
            internal extern static void BeginQueryIndexed(SharpGL.QueryTarget target, UInt32 index, UInt32 id);
            [DllImport(GL.Library, EntryPoint = "glEndQueryIndexed", ExactSpelling = true)]
            internal extern static void EndQueryIndexed(SharpGL.QueryTarget target, UInt32 index);
            [DllImport(GL.Library, EntryPoint = "glBeginTransformFeedback", ExactSpelling = true)]
            internal extern static void BeginTransformFeedback(SharpGL.BeginFeedbackMode primitiveMode);
            ...
            internal extern static void BindBuffer(SharpGL.BufferTarget target, UInt32 buffer);
            [DllImport(GL.Library, EntryPoint = "glBindBufferBase", ExactSpelling = true)]
            internal extern static void BindBufferBase(SharpGL.BufferTarget target, UInt32 index, UInt32 buffer);
            ...
            internal extern static void BindFramebuffer(SharpGL.FramebufferTarget target, UInt32 framebuffer);
            ...
            internal extern static void BindRenderbuffer(SharpGL.RenderbufferTarget target, UInt32 renderbuffer);
            ...
            internal extern static void BindTexture(SharpGL.TextureTarget target, UInt32 texture);
            ...
            internal extern static void BindTransformFeedback(SharpGL.NvTransformFeedback2 target, UInt32 id);
            ...
            internal extern static void BlendEquation(SharpGL.BlendEquationMode mode);
            ...
            internal extern static void BlendEquationSeparate(SharpGL.BlendEquationMode modeRGB, SharpGL.BlendEquationMode modeAlpha);
            ...
            internal extern static void BlendFunc(SharpGL.BlendingFactorSrc sfactor, SharpGL.BlendingFactorDest dfactor);
            ...
            internal extern static void BlendFuncSeparate(SharpGL.BlendingFactorSrc srcRGB, SharpGL.BlendingFactorDest dstRGB, SharpGL.BlendingFactorSrc srcAlpha, SharpGL.BlendingFactorDest dstAlpha);
            ...
            internal extern static void BlitFramebuffer(Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, SharpGL.ClearBufferMask mask, SharpGL.BlitFramebufferFilter filter);
            [DllImport(GL.Library, EntryPoint = "glBlitNamedFramebuffer", ExactSpelling = true)]
            internal extern static void BlitNamedFramebuffer(UInt32 readFramebuffer, UInt32 drawFramebuffer, Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, SharpGL.ClearBufferMask mask, SharpGL.BlitFramebufferFilter filter);
            [DllImport(GL.Library, EntryPoint = "glBufferData", ExactSpelling = true)]
            internal extern static void BufferData(SharpGL.BufferTarget target, IntPtr size, IntPtr data, SharpGL.BufferUsageHint usage);
            [DllImport(GL.Library, EntryPoint = "glNamedBufferData", ExactSpelling = true)]
            internal extern static void NamedBufferData(UInt32 buffer, Int32 size, IntPtr data, SharpGL.BufferUsageHint usage);
            ...
            internal extern static void BufferSubData(SharpGL.BufferTarget target, IntPtr offset, IntPtr size, IntPtr data);
            ...
            internal extern static FramebufferErrorCode CheckFramebufferStatus(SharpGL.FramebufferTarget target);
            [DllImport(GL.Library, EntryPoint = "glCheckNamedFramebufferStatus", ExactSpelling = true)]
            internal extern static FramebufferErrorCode CheckNamedFramebufferStatus(UInt32 framebuffer, SharpGL.FramebufferTarget target);
            [DllImport(GL.Library, EntryPoint = "glClampColor", ExactSpelling = true)]
            internal extern static void ClampColor(SharpGL.ClampColorTarget target, SharpGL.ClampColorMode clamp);
            [DllImport(GL.Library, EntryPoint = "glClear", ExactSpelling = true)]
            internal extern static void Clear(SharpGL.ClearBufferMask mask);
            ...
            internal extern static void ClearBufferfi(SharpGL.ClearBuffer buffer, Int32 drawbuffer, Single depth, Int32 stencil);
            ...
            internal extern static void CompressedTexImage1D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 border, Int32 imageSize, IntPtr data);
            [DllImport(GL.Library, EntryPoint = "glCompressedTexImage2D", ExactSpelling = true)]
            internal extern static void CompressedTexImage2D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, Int32 imageSize, IntPtr data);
            [DllImport(GL.Library, EntryPoint = "glCompressedTexImage3D", ExactSpelling = true)]
            internal extern static void CompressedTexImage3D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, Int32 imageSize, IntPtr data);
            [DllImport(GL.Library, EntryPoint = "glCompressedTexSubImage1D", ExactSpelling = true)]
            internal extern static void CompressedTexSubImage1D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, SharpGL.PixelFormat format, Int32 imageSize, IntPtr data);
            ...
            internal extern static void CompressedTexSubImage2D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, SharpGL.PixelFormat format, Int32 imageSize, IntPtr data);
            ...
            internal extern static void CompressedTexSubImage3D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, SharpGL.PixelFormat format, Int32 imageSize, IntPtr data);
            ...
            internal extern static void CopyBufferSubData(SharpGL.BufferTarget readTarget, SharpGL.BufferTarget writeTarget, IntPtr readOffset, IntPtr writeOffset, IntPtr size);
            ...
            internal extern static void CopyTexImage1D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 border);
            [DllImport(GL.Library, EntryPoint = "glCopyTexImage2D", ExactSpelling = true)]
            internal extern static void CopyTexImage2D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 height, Int32 border);
            [DllImport(GL.Library, EntryPoint = "glCopyTexSubImage1D", ExactSpelling = true)]
            internal extern static void CopyTexSubImage1D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 x, Int32 y, Int32 width);
            ...
            internal extern static void CopyTexSubImage2D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 x, Int32 y, Int32 width, Int32 height);
            ...
            internal extern static void CopyTexSubImage3D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 x, Int32 y, Int32 width, Int32 height);
            ...
            internal extern static UInt32 CreateShader(SharpGL.ShaderType shaderType);
            ...
            internal extern static void CullFace(SharpGL.CullFaceMode mode);
            ...
            internal extern static void DepthFunc(SharpGL.DepthFunction func);
            ...
            internal extern static void DrawArrays(SharpGL.BeginMode mode, Int32 first, Int32 count);
            [DllImport(GL.Library, EntryPoint = "glDrawArraysIndirect", ExactSpelling = true)]
            internal extern static void DrawArraysIndirect(SharpGL.BeginMode mode, IntPtr indirect);
            [DllImport(GL.Library, EntryPoint = "glDrawArraysInstanced", ExactSpelling = true)]
            internal extern static void DrawArraysInstanced(SharpGL.BeginMode mode, Int32 first, Int32 count, Int32 primcount);
            ...
            internal extern static void DrawBuffers(Int32 n, SharpGL.DrawBuffersEnum[] bufs);
            ...
            internal extern static void DrawElements(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices);
            [DllImport(GL.Library, EntryPoint = "glDrawElementsBaseVertex", ExactSpelling = true)]
            internal extern static void DrawElementsBaseVertex(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 basevertex);
            [DllImport(GL.Library, EntryPoint = "glDrawElementsIndirect", ExactSpelling = true)]
            internal extern static void DrawElementsIndirect(SharpGL.BeginMode mode, SharpGL.DrawElementsType type, IntPtr indirect);
            [DllImport(GL.Library, EntryPoint = "glDrawElementsInstanced", ExactSpelling = true)]
            internal extern static void DrawElementsInstanced(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 primcount);
            ...
            internal extern static void DrawElementsInstancedBaseVertex(SharpGL.BeginMode mode, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex);
            ...
            internal extern static void DrawRangeElements(SharpGL.BeginMode mode, UInt32 start, UInt32 end, Int32 count, SharpGL.DrawElementsType type, IntPtr indices);
            [DllImport(GL.Library, EntryPoint = "glDrawRangeElementsBaseVertex", ExactSpelling = true)]
            internal extern static void DrawRangeElementsBaseVertex(SharpGL.BeginMode mode, UInt32 start, UInt32 end, Int32 count, SharpGL.DrawElementsType type, IntPtr indices, Int32 basevertex);
            [DllImport(GL.Library, EntryPoint = "glDrawTransformFeedback", ExactSpelling = true)]
            internal extern static void DrawTransformFeedback(SharpGL.NvTransformFeedback2 mode, UInt32 id);
            ...
            internal extern static void DrawTransformFeedbackStream(SharpGL.NvTransformFeedback2 mode, UInt32 id, UInt32 stream);
            ...
            internal extern static void Enable(SharpGL.EnableCap cap);
            [DllImport(GL.Library, EntryPoint = "glDisable", ExactSpelling = true)]
            internal extern static void Disable(SharpGL.EnableCap cap);
            ...
            internal extern static IntPtr FenceSync(SharpGL.ArbSync condition, UInt32 flags);
            ...
            internal extern static void FlushMappedBufferRange(SharpGL.BufferTarget target, IntPtr offset, IntPtr length);
            ...
            internal extern static void FramebufferRenderbuffer(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, SharpGL.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
            [DllImport(GL.Library, EntryPoint = "glNamedFramebufferRenderbuffer", ExactSpelling = true)]
            internal extern static void NamedFramebufferRenderbuffer(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, SharpGL.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
            [DllImport(GL.Library, EntryPoint = "glFramebufferTexture", ExactSpelling = true)]
            internal extern static void FramebufferTexture(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level);
            ...
            internal extern static void NamedFramebufferTexture(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level);
            [DllImport(GL.Library, EntryPoint = "glFramebufferTextureLayer", ExactSpelling = true)]
            internal extern static void FramebufferTextureLayer(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
            [DllImport(GL.Library, EntryPoint = "glNamedFramebufferTextureLayer", ExactSpelling = true)]
            internal extern static void NamedFramebufferTextureLayer(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
            [DllImport(GL.Library, EntryPoint = "glFrontFace", ExactSpelling = true)]
            internal extern static void FrontFace(SharpGL.FrontFaceDirection mode);
            ...
            internal extern static void GenerateMipmap(SharpGL.GenerateMipmapTarget target);
            ...
            internal extern static void GetBooleanv(SharpGL.GetPName pname, [OutAttribute] Boolean[] data);
            [DllImport(GL.Library, EntryPoint = "glGetDoublev", ExactSpelling = true)]
            internal extern static void GetDoublev(SharpGL.GetPName pname, [OutAttribute] Double[] data);
            [DllImport(GL.Library, EntryPoint = "glGetFloatv", ExactSpelling = true)]
            internal extern static void GetFloatv(SharpGL.GetPName pname, [OutAttribute] Single[] data);
            [DllImport(GL.Library, EntryPoint = "glGetIntegerv", ExactSpelling = true)]
            internal extern static void GetIntegerv(SharpGL.GetPName pname, [OutAttribute] Int32[] data);
            [DllImport(GL.Library, EntryPoint = "glGetInteger64v", ExactSpelling = true)]
            internal extern static void GetInteger64v(SharpGL.ArbSync pname, [OutAttribute] Int64[] data);
            ...
            internal extern static void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] SharpGL.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name);
            ...
            internal extern static void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] SharpGL.ActiveUniformType[] type, [OutAttribute] System.Text.StringBuilder name);
            [DllImport(GL.Library, EntryPoint = "glGetActiveUniformBlockiv", ExactSpelling = true)]
            internal extern static void GetActiveUniformBlockiv(UInt32 program, UInt32 uniformBlockIndex, SharpGL.ActiveUniformBlockParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal extern static void GetBufferParameteriv(SharpGL.BufferTarget target, SharpGL.BufferParameterName value, [OutAttribute] Int32[] data);
            ...
            internal extern static void GetBufferPointerv(SharpGL.BufferTarget target, SharpGL.BufferPointer pname, [OutAttribute] IntPtr @params);
            [DllImport(GL.Library, EntryPoint = "glGetNamedBufferPointerv", ExactSpelling = true)]
            internal extern static void GetNamedBufferPointerv(UInt32 buffer, SharpGL.BufferPointer pname, [OutAttribute] IntPtr @params);
            [DllImport(GL.Library, EntryPoint = "glGetBufferSubData", ExactSpelling = true)]
            internal extern static void GetBufferSubData(SharpGL.BufferTarget target, IntPtr offset, IntPtr size, [OutAttribute] IntPtr data);
            ...
            internal extern static void GetCompressedTexImage(SharpGL.TextureTarget target, Int32 level, [OutAttribute] IntPtr pixels);
            ...
            internal extern static void GetFramebufferAttachmentParameteriv(SharpGL.FramebufferTarget target, SharpGL.FramebufferAttachment attachment, SharpGL.FramebufferParameterName pname, [OutAttribute] Int32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetNamedFramebufferAttachmentParameteriv", ExactSpelling = true)]
            internal extern static void GetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, SharpGL.FramebufferAttachment attachment, SharpGL.FramebufferParameterName pname, [OutAttribute] Int32[] @params);
            ...
            internal extern static void GetMultisamplefv(SharpGL.GetMultisamplePName pname, UInt32 index, [OutAttribute] Single[] val);
            [DllImport(GL.Library, EntryPoint = "glGetObjectLabel", ExactSpelling = true)]
            internal extern static void GetObjectLabel(SharpGL.ObjectLabel identifier, UInt32 name, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder label);
            ...
            internal extern static void GetProgramiv(UInt32 program, SharpGL.ProgramParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal extern static void GetQueryiv(SharpGL.QueryTarget target, SharpGL.GetQueryParam pname, [OutAttribute] Int32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetQueryObjectiv", ExactSpelling = true)]
            internal extern static void GetQueryObjectiv(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] Int32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetQueryObjectuiv", ExactSpelling = true)]
            internal extern static void GetQueryObjectuiv(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] UInt32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetQueryObjecti64v", ExactSpelling = true)]
            internal extern static void GetQueryObjecti64v(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] Int64[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetQueryObjectui64v", ExactSpelling = true)]
            internal extern static void GetQueryObjectui64v(UInt32 id, SharpGL.GetQueryObjectParam pname, [OutAttribute] UInt64[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetRenderbufferParameteriv", ExactSpelling = true)]
            internal extern static void GetRenderbufferParameteriv(SharpGL.RenderbufferTarget target, SharpGL.RenderbufferParameterName pname, [OutAttribute] Int32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetNamedRenderbufferParameteriv", ExactSpelling = true)]
            internal extern static void GetNamedRenderbufferParameteriv(UInt32 renderbuffer, SharpGL.RenderbufferParameterName pname, [OutAttribute] Int32[] @params);
            ...
            internal extern static void GetShaderiv(UInt32 shader, SharpGL.ShaderParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal extern static void GetShaderPrecisionFormat(SharpGL.ShaderType shaderType, Int32 precisionType, [OutAttribute] Int32[] range, [OutAttribute] Int32[] precision);
            ...
            internal extern static IntPtr GetString(SharpGL.StringName name);
            [DllImport(GL.Library, EntryPoint = "glGetStringi", ExactSpelling = true)]
            internal extern static IntPtr GetStringi(SharpGL.StringName name, UInt32 index);
            ...
            internal extern static void GetSynciv(IntPtr sync, SharpGL.ArbSync pname, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] values);
            [DllImport(GL.Library, EntryPoint = "glGetTexImage", ExactSpelling = true)]
            internal extern static void GetTexImage(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelFormat format, SharpGL.PixelType type, [OutAttribute] IntPtr pixels);
            ...
            internal extern static void GetTexParameterfv(SharpGL.TextureTarget target, SharpGL.GetTextureParameter pname, [OutAttribute] Single[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetTexParameteriv", ExactSpelling = true)]
            internal extern static void GetTexParameteriv(SharpGL.TextureTarget target, SharpGL.GetTextureParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal extern static void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] SharpGL.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name);
            ...
            internal extern static void GetVertexAttribdv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Double[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetVertexAttribfv", ExactSpelling = true)]
            internal extern static void GetVertexAttribfv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Single[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetVertexAttribiv", ExactSpelling = true)]
            internal extern static void GetVertexAttribiv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Int32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetVertexAttribIiv", ExactSpelling = true)]
            internal extern static void GetVertexAttribIiv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Int32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetVertexAttribIuiv", ExactSpelling = true)]
            internal extern static void GetVertexAttribIuiv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] UInt32[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetVertexAttribLdv", ExactSpelling = true)]
            internal extern static void GetVertexAttribLdv(UInt32 index, SharpGL.VertexAttribParameter pname, [OutAttribute] Double[] @params);
            [DllImport(GL.Library, EntryPoint = "glGetVertexAttribPointerv", ExactSpelling = true)]
            internal extern static void GetVertexAttribPointerv(UInt32 index, SharpGL.VertexAttribPointerParameter pname, [OutAttribute] IntPtr pointer);
            [DllImport(GL.Library, EntryPoint = "glHint", ExactSpelling = true)]
            internal extern static void Hint(HintTarget target, SharpGL.HintMode mode);
            ...
            internal extern static Boolean IsEnabled(SharpGL.EnableCap cap);
            ...
            internal extern static void LogicOp(SharpGL.LogicOp opcode);
            [DllImport(GL.Library, EntryPoint = "glMapBuffer", ExactSpelling = true)]
            internal extern static IntPtr MapBuffer(SharpGL.BufferTarget target, SharpGL.BufferAccess access);
            [DllImport(GL.Library, EntryPoint = "glMapNamedBuffer", ExactSpelling = true)]
            internal extern static IntPtr MapNamedBuffer(UInt32 buffer, SharpGL.BufferAccess access);
            [DllImport(GL.Library, EntryPoint = "glMapBufferRange", ExactSpelling = true)]
            internal extern static IntPtr MapBufferRange(SharpGL.BufferTarget target, IntPtr offset, IntPtr length, SharpGL.BufferAccessMask access);
            ...
            internal extern static void MultiDrawArrays(SharpGL.BeginMode mode, Int32[] first, Int32[] count, Int32 drawcount);
            ...
            internal extern static void MultiDrawElements(SharpGL.BeginMode mode, Int32[] count, SharpGL.DrawElementsType type, IntPtr indices, Int32 drawcount);
            [DllImport(GL.Library, EntryPoint = "glMultiDrawElementsBaseVertex", ExactSpelling = true)]
            internal extern static void MultiDrawElementsBaseVertex(SharpGL.BeginMode mode, Int32[] count, SharpGL.DrawElementsType type, IntPtr indices, Int32 drawcount, Int32[] basevertex);
            [DllImport(GL.Library, EntryPoint = "glMultiDrawElementsIndirect", ExactSpelling = true)]
            internal extern static void MultiDrawElementsIndirect(SharpGL.BeginMode mode, SharpGL.DrawElementsType type, IntPtr indirect, Int32 drawcount, Int32 stride);
            [DllImport(GL.Library, EntryPoint = "glObjectLabel", ExactSpelling = true)]
            internal extern static void ObjectLabel(SharpGL.ObjectLabel identifier, UInt32 name, Int32 length, String label);
            ...
            internal extern static void PixelStoref(SharpGL.PixelStoreParameter pname, Single param);
            [DllImport(GL.Library, EntryPoint = "glPixelStorei", ExactSpelling = true)]
            internal extern static void PixelStorei(SharpGL.PixelStoreParameter pname, Int32 param);
            [DllImport(GL.Library, EntryPoint = "glPointParameterf", ExactSpelling = true)]
            internal extern static void PointParameterf(SharpGL.PointParameterName pname, Single param);
            [DllImport(GL.Library, EntryPoint = "glPointParameteri", ExactSpelling = true)]
            internal extern static void PointParameteri(SharpGL.PointParameterName pname, Int32 param);
            ...
            internal extern static void PolygonMode(SharpGL.MaterialFace face, SharpGL.PolygonMode mode);
            ...
            internal extern static void ProgramParameteri(UInt32 program, SharpGL.Version32 pname, Int32 value);
            ...
            internal extern static void ProvokingVertex(SharpGL.ProvokingVertexMode provokeMode);
            [DllImport(GL.Library, EntryPoint = "glQueryCounter", ExactSpelling = true)]
            internal extern static void QueryCounter(UInt32 id, SharpGL.QueryTarget target);
            [DllImport(GL.Library, EntryPoint = "glReadBuffer", ExactSpelling = true)]
            internal extern static void ReadBuffer(SharpGL.ReadBufferMode mode);
            ...
            internal extern static void ReadPixels(Int32 x, Int32 y, Int32 width, Int32 height, SharpGL.PixelFormat format, SharpGL.PixelType type, Int32[] data);
            [DllImport(GL.Library, EntryPoint = "glReadnPixels", ExactSpelling = true)]
            internal extern static void ReadnPixels(Int32 x, Int32 y, Int32 width, Int32 height, SharpGL.PixelFormat format, SharpGL.PixelType type, Int32 bufSize, Int32[] data);
            [DllImport(GL.Library, EntryPoint = "glRenderbufferStorage", ExactSpelling = true)]
            internal extern static void RenderbufferStorage(SharpGL.RenderbufferTarget target, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            [DllImport(GL.Library, EntryPoint = "glNamedRenderbufferStorage", ExactSpelling = true)]
            internal extern static void NamedRenderbufferStorage(UInt32 renderbuffer, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            [DllImport(GL.Library, EntryPoint = "glRenderbufferStorageMultisample", ExactSpelling = true)]
            internal extern static void RenderbufferStorageMultisample(SharpGL.RenderbufferTarget target, Int32 samples, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            [DllImport(GL.Library, EntryPoint = "glNamedRenderbufferStorageMultisample", ExactSpelling = true)]
            internal extern static void NamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, SharpGL.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            ...
            internal extern static void StencilFunc(SharpGL.StencilFunction func, Int32 @ref, UInt32 mask);
            [DllImport(GL.Library, EntryPoint = "glStencilFuncSeparate", ExactSpelling = true)]
            internal extern static void StencilFuncSeparate(SharpGL.StencilFace face, SharpGL.StencilFunction func, Int32 @ref, UInt32 mask);
            ...
            internal extern static void StencilMaskSeparate(SharpGL.StencilFace face, UInt32 mask);
            [DllImport(GL.Library, EntryPoint = "glStencilOp", ExactSpelling = true)]
            internal extern static void StencilOp(SharpGL.StencilOp sfail, SharpGL.StencilOp dpfail, SharpGL.StencilOp dppass);
            [DllImport(GL.Library, EntryPoint = "glStencilOpSeparate", ExactSpelling = true)]
            internal extern static void StencilOpSeparate(SharpGL.StencilFace face, SharpGL.StencilOp sfail, SharpGL.StencilOp dpfail, SharpGL.StencilOp dppass);
            [DllImport(GL.Library, EntryPoint = "glTexBuffer", ExactSpelling = true)]
            internal extern static void TexBuffer(SharpGL.TextureBufferTarget target, SharpGL.SizedInternalFormat internalFormat, UInt32 buffer);
            [DllImport(GL.Library, EntryPoint = "glTextureBuffer", ExactSpelling = true)]
            internal extern static void TextureBuffer(UInt32 texture, SharpGL.SizedInternalFormat internalFormat, UInt32 buffer);
            ...
            internal extern static void TexImage1D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 border, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr data);
            [DllImport(GL.Library, EntryPoint = "glTexImage2D", ExactSpelling = true)]
            internal extern static void TexImage2D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr data);
            [DllImport(GL.Library, EntryPoint = "glTexImage2DMultisample", ExactSpelling = true)]
            internal extern static void TexImage2DMultisample(SharpGL.TextureTargetMultisample target, Int32 samples, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
            [DllImport(GL.Library, EntryPoint = "glTexImage3D", ExactSpelling = true)]
            internal extern static void TexImage3D(SharpGL.TextureTarget target, Int32 level, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr data);
            [DllImport(GL.Library, EntryPoint = "glTexImage3DMultisample", ExactSpelling = true)]
            internal extern static void TexImage3DMultisample(SharpGL.TextureTargetMultisample target, Int32 samples, SharpGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
            [DllImport(GL.Library, EntryPoint = "glTexParameterf", ExactSpelling = true)]
            internal extern static void TexParameterf(SharpGL.TextureTarget target, TextureParameterName pname, Single param);
            [DllImport(GL.Library, EntryPoint = "glTexParameteri", ExactSpelling = true)]
            internal extern static void TexParameteri(SharpGL.TextureTarget target, TextureParameterName pname, Int32 param);
            ...
            internal extern static void TexParameterfv(SharpGL.TextureTarget target, TextureParameterName pname, Single[] @params);
            [DllImport(GL.Library, EntryPoint = "glTexParameteriv", ExactSpelling = true)]
            internal extern static void TexParameteriv(SharpGL.TextureTarget target, TextureParameterName pname, Int32[] @params);
            ...
            internal extern static void TexSubImage1D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr pixels);
            ...
            internal extern static void TexSubImage2D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr pixels);
            ...
            internal extern static void TexSubImage3D(SharpGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, SharpGL.PixelFormat format, SharpGL.PixelType type, IntPtr pixels);
            ...
            internal extern static void TransformFeedbackVaryings(UInt32 program, Int32 count, String[] varyings, SharpGL.TransformFeedbackMode bufferMode);
            ...
            internal extern static Boolean UnmapBuffer(SharpGL.BufferTarget target);
            ...
            internal extern static void VertexAttribFormat(UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            [DllImport(GL.Library, EntryPoint = "glVertexAttribIFormat", ExactSpelling = true)]
            internal extern static void VertexAttribIFormat(UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            [DllImport(GL.Library, EntryPoint = "glVertexAttribLFormat", ExactSpelling = true)]
            internal extern static void VertexAttribLFormat(UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            [DllImport(GL.Library, EntryPoint = "glVertexArrayAttribFormat", ExactSpelling = true)]
            internal extern static void VertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            [DllImport(GL.Library, EntryPoint = "glVertexArrayAttribIFormat", ExactSpelling = true)]
            internal extern static void VertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            [DllImport(GL.Library, EntryPoint = "glVertexArrayAttribLFormat", ExactSpelling = true)]
            internal extern static void VertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, SharpGL.VertexAttribFormat type, UInt32 relativeoffset);
            [DllImport(GL.Library, EntryPoint = "glVertexAttribPointer", ExactSpelling = true)]
            internal extern static void VertexAttribPointer(UInt32 index, Int32 size, SharpGL.VertexAttribPointerType type, Boolean normalized, Int32 stride, IntPtr pointer);
